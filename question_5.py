...
hm_text = (
    ...
    .encode(
        ...
        y=alt.Y("season:O", sort=alt.SortOrder("descending")),
    ...
    .properties(
        ...
        title=alt.TitleParams(
            ...
            subtitle=[
                ...
                "Cell text = IMDB rating · white text = high-viewership cell",
                "Row = season (1 top, 28 bottom) · Column = episode number in season",
            ],
